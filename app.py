...
with tab2:
    ...
    with tab24:
        ...
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiY2Q5NmQ1YzItMTJlYS00ZGM2LThlMGEtNDA1NmI2MWEyN2MzIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1024, height=804)
