...
def get_recommendations_par_genre(genre, id_film):
    ...
    try:
        ...
        st.error("Euhhh JB j'ai une question5")
        return []
...
with tab2:
    ...
    with tab21:
        ...
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiN2U0MjM3M2MtM2UzMy00YjVkLWFhM2EtY2NkYjM1YTRlN2JiIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1152, height=648)

    with tab22:
        # embed streamlit docs in a streamlit app
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiM2NlYzM2NmQtYzI0OS00NzBjLTg2NTAtNzE0OWI1MTc4MTQyIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1152, height=648)

    with tab23:
        # embed streamlit docs in a streamlit app
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiNDg4ZGI1MDMtMWJlNi00YjY5LTljYjktMGZkZjI5NTY4N2QzIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1152, height=648)

    with tab24:
        # embed streamlit docs in a streamlit app
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiMzczOWYwZTAtNzQ3OS00MzZiLTkxNTEtMzY2ZTQ0ZDhjNjUyIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1152, height=648)
