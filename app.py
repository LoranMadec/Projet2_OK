...
with tab2:
    ...
    with tab24:
        ...
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiMTY5OWU3MTgtMTIwZS00NTk2LWIyNTAtZDA3MzA4MTBhNWVjIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1024, height=804)
