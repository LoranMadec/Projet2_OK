...
with tab2:
    ...
    with tab24:
        ...
        components.iframe("https://app.powerbi.com/view?r=eyJrIjoiNjhmYTVkNDktMDZiZC00NWNkLWI5NWEtZWI3YzVmNmQ2ZjljIiwidCI6ImYyODRkYTU4LWMwOTMtNGZiOS1hM2NiLTAyNDNjM2EwMTRhYyJ9", width=1024, height=804)
